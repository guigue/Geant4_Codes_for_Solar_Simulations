...
// ********************************************************************
//
/// \file field/field01/src/Solar_FieldSetup.cc
/// \brief Implementation of the Solar_FieldSetup class
//
//
// $Id: Solar_FieldSetup.cc 100688 2016-10-31 11:21:51Z gcosmo $
//
...
Solar_FieldSetup::Solar_FieldSetup(/*G4double pGradient*/)
 : fFieldManager(0),
   fChordFinder(0),
   fEquation(0),
   fMagneticField(new Solar_TabulatedField("dbdipole.txt")),
   fStepper(0),
   fStepperType(0),
   fMinStep(0.),
   fFieldMessenger(0),
