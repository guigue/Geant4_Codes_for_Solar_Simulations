...
//Dimensions
G4double solar_x = 1.2*lh;
G4double solar_y = 1.2*lh;
...
//World
G4double world_hx = 1.2*lh;
G4double world_hy = 1.2*lh;
...
//Set different Cuts for this region

//G4ProductionCuts*atmcuts = new G4ProductionCuts();
//atmcuts->SetProductionCut(1.*cm, "gamma");
//atmcuts->SetProductionCut(1.*cm, "e-");
//atmcuts->SetProductionCut(1.*cm, "e+");
...
//CoronaCuts->SetProductionCut(1.*cm, "gamma");
//CoronaCuts->SetProductionCut(1.*cm, "e-");
//CoronaCuts->SetProductionCut(1.*cm, "e+");
...
SolarUserLimits->SetUserMaxTime(0.1*s);
CoronaLog->SetUserLimits(SolarUserLimits);

//SolarUserLimits = new G4UserLimits ();
//SolarUserLimits->SetUserMaxTrackLength(TrackMax);
