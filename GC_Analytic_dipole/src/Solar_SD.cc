...
// ********************************************************************
//
// $Id: Solar_SD.cc 100946 2016-11-03 11:28:08Z gcosmo $
//
/// \file Solar_SD.cc
/// \brief Implementation of the Solar_SD class
...
if (CurrentProcess != 0)
{
  ...
  //G4String SD1 = preStepPoint->GetSensitiveDetector()->GetName();
  //G4String SD2 = postStepPoint->GetSensitiveDetector()->GetName();
// Track trajectory of one particle

// if (particle == "gamma" || particle == "proton" || particle == "e-" || particle == "e+" || particle == "neutron" )
// {
...
// analysisManager->FillNtupleDColumn(0, 4, globalPosition.x()/cm);
// analysisManager->FillNtupleDColumn(0, 5, globalPosition.y()/cm);
// analysisManager->FillNtupleDColumn(0, 6, globalPosition.z()/cm);
